...
- `organize-processor-docs` is a stateless Skill for human-first processor documentation architecture, evidence, and review.
- Its Bootstrap, Author, and Maintain workflows use target-budget warnings, configurable provisional hard thresholds, two-link Architecture and Design navigation checks, encoding diagnostics, and separate handling for explanatory diagrams and evidence captures.
